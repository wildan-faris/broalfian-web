    ...
    <>
      ...
      <div className="w-10/12 md:w-5/12">
        <p className=" text-xs md:text-sm leading-snug text-secondary">
          I am a <span className="font-bold">{props.position}</span> based in{' '}
          <span className="font-bold">{props.country}</span>, passionate about
          crafting robust and user-friendly web applications.{' '}
        </p>
      </div>
      <nav className="flex flex-col md:flex-row md:space-x-10 space-y-1 md:space-y-0 ">
        <Link
          to="/about"
